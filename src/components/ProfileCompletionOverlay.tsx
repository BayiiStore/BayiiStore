    ...
    <div className="fixed inset-0 bg-black/95 backdrop-blur-md z-[100] flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center gap-3 mb-4 flex-shrink-0">
          <div className="p-2.5 bg-indigo-600/10 border border-indigo-600/30 text-indigo-400 rounded-2xl">
            <ShieldCheck className="w-5 h-5" />
          </div>
          <div>
            <h2 className="text-base md:text-lg font-black text-white font-sans uppercase tracking-wider">
        ...
        <div className="flex-1 overflow-y-auto pr-1 md:pr-1.5 space-y-4 scrollbar-thin scrollbar-thumb-zinc-800 scrollbar-track-transparent">
          <div className="p-3 bg-indigo-500/5 border border-indigo-500/10 text-zinc-300 rounded-2xl text-[11px] space-y-1.5">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 bg-zinc-900 border border-zinc-800 rounded-xl text-xs font-semibold text-white placeholder-zinc-600 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/15 transition-all"
                />
              </div>
            ...
            <div className="space-y-2.5 my-3 border-t border-b border-zinc-900 py-3 px-1">
            ...
            <button
              ...
              className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-sans font-extrabold py-3 px-4 rounded-xl transition-all shadow-lg shadow-indigo-500/10 text-xs flex items-center justify-center gap-2 cursor-pointer mt-4 uppercase tracking-wider"
            >
              {isLoading ? (
                <>
